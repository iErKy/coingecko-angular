...
export class BaseService {
    ...
    public configuration: CoinGeckoConfiguration;
    public encoder: HttpParameterCodec;

    constructor(basePath?: string|string[], configuration?: CoinGeckoConfiguration) {
        this.configuration = configuration || new CoinGeckoConfiguration();
